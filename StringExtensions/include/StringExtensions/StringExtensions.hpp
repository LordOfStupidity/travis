...
namespace StringExtensions {
    ...
    /**
     * This function is like the vsprintf function in the standard C
    ...
    /**
     * This function is like the sprintf function in the standard C
     * library, except that it constructs the string dynamically and
     * returns it as a std::string value.
     */
     ...
     * found in the input string is prefixed by the give "escapeCharacter".
     *
     * @param[in] s
     ...
     * given delimeter, returning the pieces as a collection of substrings.
     ...
     *
     * @param[in] d
     *      This is the delimeter character at which to split the string.
     *
     * @return
     ...
     * This function breaks the given string at each instance of the
     * given delimeter, returning the pieces as a collection of substrings.
     * The delimiter strings are removed.
     *
     * @param[in] s
     *      This is the string to split.
     *
     * @param[in] d
     *      This is the delimeter substrings at which to split the string.
     *
     * @return
     *      The collection of substrings that result from breaking the given
     *      string at each delimiter character is returned.
     */
    std::vector<std::string> Split(const std::string& s, std::string& d);

    /**
     * This function joins together the given squence of smaller strings
    ...
    enum class ToIntegerResult {
        /**
         * This indicated the size was parsed successfully.
         */
        Success,

        /**
         * This indicated the size had one or more characters
     ...
     *      This is the string containing the number of parse.
     *
     * @param[out] number
     ...
     */
    std::string InstantiateTemplate(const std::string& templateText, const std::map<std::string, std::string>& variables);
}
